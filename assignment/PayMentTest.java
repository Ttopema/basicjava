...
public class PayMentTest {
	...
	public static void main(String[] args) throws PayException {
		...
		CardPayment card1 = new CardPayment("11번가", "Java책", 17000, "123-432-111", "0070", 0); // 6개 생성자 만들기
		payProcess(card1); // 메소드 매개변수 1, 리턴 x
		System.out.println("-------------------------------------");
		CashPayment cash1 = new CashPayment("인터파크", "에어컨", 2400000, "198-32"); // 4개 생성자 만들기
		payProcess(cash1);
		System.out.println("-------------------------------------");
