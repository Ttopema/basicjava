...
public class Company {
	public static void main(String[] args) {
		Secretary sec = new Secretary("Hilery", 1, "secretary", 800); //매개변수 4개 생성자
		Sales sal = new Sales("Clinten", 2, "sales", 1200); //매개변수 4개 생성자
		System.out.println("name \t\t department \t salary");
		System.out.println("------------------------------------------");
		System.out.println(sec.getName() + " \t\t " + sec.getDepartment() //리턴타입 ㅇ
				+ " \t " + sec.getSalary());
